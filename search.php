                        ...
                        <div class="col-lg d-flex">
                          <div class="form-group d-flex w-100 border-0">
                            <div class="form-field w-100 align-items-center d-flex">
                              <input type="submit" name="sub" value="Search" class="align-self-stretch form-control btn btn-primary">
                            </div>
                          </div>
                        </div>
                      </div>
...
<section class="ftco-section">
        ...
        if (isset($_POST['sub'])) {
          $str=$_POST['input'];
          $q = "SELECT * FROM `details1` where name like '$str%'";
                ...
                <div class="col-md pt-5 border-left">
                  <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <div class="block-23 mb-3">
                      <ul>
                        <li><span class="icon fa fa-map-marker"></span><span class="text">203 Fake St. Mountain View,
