...
<body>
 ...
 <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url(https://www.keralam.me/wp-content/uploads/2019/03/Kerala-beaches.jpg);">
...
<button type ="submit" name='register'>Register</button>
       ...
       <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span>Sign up <i class="fa fa-chevron-right"></i></span></p>
...
$reg="INSERT INTO `reg_usrs1`( `name`, `email`, `usr_name`, `password`) VALUES ('$name','$email','$user','$password')";
