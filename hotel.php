...
<section class="ftco-section">
        ...
        // $pa=$_GET['para'];
        $u=$_GET['url'];
				$q="SELECT * FROM `hotels1` WHERE place ='$l'";
				...
				if($result){
					...
					while($val = mysqli_fetch_assoc($result)){
						...
						<?php
						echo("
							<div class='img' style='background-image: url(".$val['img'].");'>
                           </div>
						   ");
						   ?>
							<div class="text p-4">
								...
								<?php
								echo("<h3><div id='hotl'>$val[hotel_name]</div></h3>");
								 
                echo("<a href='accountinsert.php?place=$val[hotel_name]&img=$u'>
                book your trip
                    </a>");
                ?>
                
                <!-- <form action="" method="post">
                  <input type="submit" name="return" value="Book Your Trip">
                </form> -->
                
                <?php
			// 					echo("<p>
      // <a href='accountmain.php?id=$val[id]&place=$val[place]&location=$val[location]&h_name=$val[hotel_name]&h_mail=$val[mail_id]&price=$val[price]&u=$u'>Book Your Trip</a></p>");
